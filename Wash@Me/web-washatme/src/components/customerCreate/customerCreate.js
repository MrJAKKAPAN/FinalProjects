...
import { Layout, Menu, Breadcrumb, Form, Input, InputNumber, Button, Select,Space } from "antd";
...
class CustomerCreate extends Component {
  ...
  onFinish = values => {
      ...
      httpClient.post(`http://localhost:8085/api/v1/customer/customer/`, formData)
        .then(res => {
            ...
            <Layout style={{ padding: "0 24px 24px" }}>
              <Content className="site-layout-background" style={{ padding: 24, margin: 0, minHeight: 450, }}>
                ...
                <Form.Item name='cus_tel' label="เบอร์โทร" onChange={this.handleChange} rules={[{required: true,message: 'โปรดระบุเบอร์โทร',pattern: new RegExp(/^-?(0|[1-9][0-9]*)(\.[0-9]*)?$/)}]} >
                  <Input   placeholder="เบอร์โทร"  style={{width: '100%',}} maxLength={10} minLength={10}/>
                </Form.Item>
